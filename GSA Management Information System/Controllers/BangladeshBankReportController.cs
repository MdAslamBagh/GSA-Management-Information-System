...
{
    public class BangladeshBankReportController : Controller
    {
        ...
        public ActionResult Export(string fromdate, string todate, string reportname, string checkdate,string clickbtn)
        {
            ...
            if (reportname == "BANGLADESH BANK REPORT-DATE WISE")
            {

                rd.Load(Path.Combine(Server.MapPath("~/Reports/Cargo"), "crpBangladeshBankReport.rpt"));
