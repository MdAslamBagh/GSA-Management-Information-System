...
{
    public class CourierOutboundSalesInformationController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: CourierOutboundSalesInformation
        public ActionResult Index()
        {
            return View(db.CourierOutboundSalesInformations.ToList());
        }
        // GET: CourierOutboundSalesInformation/Create
        ...
        // POST: CourierOutboundSalesInformation/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Add(CourierOutboundSalesInformation courierOutboundSalesInformation)
        {
            if (ModelState.IsValid)
            {
                courierOutboundSalesInformation.Airway_No = courierOutboundSalesInformation.MAWB + courierOutboundSalesInformation.Check_Digit;
                StockIssueDetailInformations stockIssueDetailInformations = new StockIssueDetailInformations();
                stockIssueDetailInformations = db.StockIssueDetailInformations.Where(a => a.Ticket_No.ToString() == courierOutboundSalesInformation.MAWB).FirstOrDefault();
                db.CourierOutboundSalesInformations.Attach(courierOutboundSalesInformation);
            ...
            return View(courierOutboundSalesInformation);
        }
       ...
       {          
        ...
        // GET: CourierOutboundSalesInformation/Details/5
        public ActionResult Details(int? id)
        {
            ...
            CourierOutboundSalesInformation courierOutboundSalesInformation = db.CourierOutboundSalesInformations.Find(id);
            if (courierOutboundSalesInformation == null)
            {
                return HttpNotFound();
            }
            return View(courierOutboundSalesInformation);
        ...
        // GET: CourierOutboundSalesInformation/Edit/5
        ...
        // POST: CourierOutboundSalesInformation/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Slno,Invoice_Type,MAWB,Check_Digit,Flight_Date,Airway_No,Freighter,Origin_Code,Dest_Code,Continent_Code,PaymentMode_Code,CFPaymode_Code,Route_Code,Customer_Code,Cargo_Code,UType_Code,HBL_Qty,AMS,Gross_Weight,Chargeable_Weight,Rate_Charge,B_Rate,Agent_Commission,AIT,THC,SSC,FSC_Charge,ISS_Charge,HDS,Others,Consignee_Code,Consignor_Code,Receivable_From_Agent,Remarks,Currency,Exchange_Rate,Receivable_Amount_BDT,Payable_Agent_CC,Remarks_B_Bank,Entry_Date")] CourierOutboundSalesInformation courierOutboundSalesInformation)
        {
            if (ModelState.IsValid)
            {
                db.Entry(courierOutboundSalesInformation).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(courierOutboundSalesInformation);
        ...
        // GET: CourierOutboundSalesInformation/Delete/5
        ...
        // POST: CourierOutboundSalesInformation/Delete/5
        [HttpPost, ActionName("Delete")]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteConfirmed(int id)
        {
            CourierOutboundSalesInformation courierOutboundSalesInformation = db.CourierOutboundSalesInformations.Find(id);
            db.CourierOutboundSalesInformations.Remove(courierOutboundSalesInformation);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
