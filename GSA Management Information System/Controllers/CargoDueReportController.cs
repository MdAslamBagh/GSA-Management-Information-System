...
{
    public class CargoDueReportController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var subMenuId = db.SubMenuInformations.Where(a => a.SubMenuId == 1117).FirstOrDefault();
        ...
        public JsonResult Get_Customer_Name(string Prefix)
        {
            ...
            //ApplicationDbContext db = new ApplicationDbContext();
            //SqlDataReader sdr = new SqlDataReader();
            SqlCommand com = new SqlCommand("spSearchAgencyCustomer", con);
            com.CommandType = CommandType.StoredProcedure;
            //com.Parameters.add("@CargoType", SqlDbType.VarChar, 50).Value = Prefix + "%";
            ...
            while (reader.Read())
            {
                customer.Add(reader["Comp_Name"].ToString());
        ...
        public JsonResult Get_MAWB(string Prefix)
        {
            ...
            //ApplicationDbContext db = new ApplicationDbContext();
            //SqlDataReader sdr = new SqlDataReader();
            SqlCommand com = new SqlCommand("spSearchMAWB", con);
            com.CommandType = CommandType.StoredProcedure;
            //com.Parameters.add("@CargoType", SqlDbType.VarChar, 50).Value = Prefix + "%";
            com.Parameters.AddWithValue("@MAWB", Prefix + '%');

            SqlDataReader reader = com.ExecuteReader();
            List<string> mawb = new List<string>();
            while (reader.Read())
            {
                mawb.Add(reader["Airway_No"].ToString());
        ...
        public ActionResult Export(DateTime DateFrom, DateTime DateTo, int reportid, bool customerallitemcheck, string customer, bool mawballitemcheck, string mawb, string clickbtn)
        {

            ReportDocument rd = new ReportDocument();
            connection();

            SqlCommand com = new SqlCommand("vwSalesWise_Cargo_Due_Receipt", con);
            com.CommandType = CommandType.StoredProcedure;
            ...
            if (reportid == 26)
            {
                ...
                rd.Load(Path.Combine(Server.MapPath("~/Reports/Cargo"), "CargoDueReceivedMAWBWiseAgencySummary.rpt"));
                ...
                if (mawballitemcheck == true)
                {
                    //com.Parameters.Add(new SqlParameter("@From_Item", DBNull.Value));
                    //com.Parameters.Add(new SqlParameter("@To_Item", DBNull.Value));
                    com.Parameters.Add(new SqlParameter("@MAWB", "%%"));

                }
                else
                {
                    com.Parameters.Add(new SqlParameter("@MAWB", customer));
                    //com.Parameters.Add(new SqlParameter("@From_Item", DBNull.Value));
                    //com.Parameters.Add(new SqlParameter("@To_Item", DBNull.Value));
                    //com.Parameters.Add(new SqlParameter("@From_Item", DBNull.Value));
                    //com.Parameters.Add(new SqlParameter("@To_Item", DBNull.Value));
            ...
            {
                //D:\project\Software\GSA Management Information System\Reports\rptTest.rpt
                rd.Load(Path.Combine(Server.MapPath("~/Reports/Cargo"), "CargoDueReceivedAgencyWise.rpt"));
