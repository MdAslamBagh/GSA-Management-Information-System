...
namespace GSA_Management_Information_System.Extensions
{
    public static class ClaimsExtensions
    {
        static string GetUserEmail(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "GSA_Management_Information_System.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "GSA_Management_Information_System.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
